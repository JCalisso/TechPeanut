...
BEGIN
  CREATE TABLE dbo.Privilegio (ID_Privilegio Integer Primary Key Identity(1,1)
...
BEGIN
  CREATE TABLE dbo.Funcao (ID_Funcao Integer Primary Key Identity(1,1)
...
BEGIN
  CREATE TABLE dbo.FuncaoPrivilegio (ID_Funcao_Privilegio Integer Primary Key Identity(1,1)
                                    ,ID_Privilegio        Integer   NOT NULL
                                    ,ID_Funcao            Integer   NOT NULL
                                    ,CONSTRAINT FK_ID_Privilegio FOREIGN KEY (ID_Privilegio) REFERENCES dbo.Privilegio (ID_Privilegio)
                                    ,CONSTRAINT FK_ID_Funcao FOREIGN KEY (ID_Funcao) REFERENCES dbo.Funcao (ID_Funcao)) 
END
GO
...
BEGIN
  CREATE TABLE dbo.Banco (ID_Banco Integer Primary Key Identity(1,1)
...
BEGIN
  CREATE TABLE dbo.DadosBancarios (ID_Dados_Bancarios Integer Primary Key Identity(1,1)
                                  ,ID_Banco           Integer
                                  ...
                                  ,CONSTRAINT FK_ID_Dados_Bancarios FOREIGN KEY (ID_Dados_Bancarios) REFERENCES dbo.DadosBancarios (ID_Dados_Bancarios))
                                    
END
GO
...
BEGIN
  CREATE TABLE dbo.DadosPessoaJuridica (ID_Pessoa         Integer 
...
BEGIN
  CREATE TABLE dbo.DadosPessoasFisica (ID_Pessoa         Integer
...
BEGIN
  CREATE TABLE dbo.Endereco (ID_Endereco Integer Primary Key Identity(1,1)
...
BEGIN
  CREATE TABLE dbo.Cidades (ID_Cidade  Integer Primary Key Identity(1,1)
...
BEGIN
  CREATE TABLE dbo.Telefones (ID_Telefone      Integer Primary Key Identity(1,1)
                             ...
                             ,CONSTRAINT FK_ID_Cidade FOREIGN KEY (ID_Cidade) REFERENCES dbo.Cidades (ID_Cidade))
END 
GO
...
BEGIN
  CREATE TABLE dbo.Emails (ID_Email           Integer Primary Key Identity(1,1)
